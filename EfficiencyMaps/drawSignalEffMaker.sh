...
for charFrac in "${arrToUseCharFrac[@]}"
  ...
  for indexPol in "${arrToUseIndexPol[@]}"
    ...
    echo "./DrawSignalStuff -wpt ${whichMacro} T2SMS ${whichT2} charFrac ${charFrac} indexPol ${indexPol} cuts ${cutMT2ll} ${cutMT2lblb} ${cutMT2bb} ${strSyst} -b -q"
    ./DrawSignalStuff -wpt ${whichMacro} T2SMS ${whichT2} charFrac ${charFrac} indexPol ${indexPol} cuts ${cutMT2ll} ${cutMT2lblb} ${cutMT2bb} ${strSyst} -b -q
    if [ ${whichMacro} -gt 2 ]
	then
	echo "./DrawSignalStuff -wpt ${whichMacro} T2SMS ${whichT2} charFrac ${charFrac} indexPol ${indexPol} cuts 80 0 -1 doControl controlCuts 80 0 -1 doSC -b -q"
	./DrawSignalStuff -wpt ${whichMacro} T2SMS ${whichT2} charFrac ${charFrac} indexPol ${indexPol} cuts 80 0 -1 doControl controlCuts 80 0 -1 doSC -b -q
    fi
  done
done
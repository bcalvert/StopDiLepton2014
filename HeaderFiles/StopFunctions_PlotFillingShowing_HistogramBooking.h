...
using namespace std;
inline void Book1DHists(HMap_1D &inHMap_1D, vector<HistogramT> * inHistVec_1D, SampleT * inSampT, SpecialAxisBounds * inSAB) {
    TH1F * h_1DCurr;
...
inline void Book2DHists(HMap_2D &inHMap_2D, vector<HistogramT> * inHistVec_2D, SampleT * inSampT, SpecialAxisBounds * inSAB) {
    TH2F * h_2DCurr;
...
inline void Book3DHists(HMap_3D &inHMap_3D, vector<HistogramT> * inHistVec_3D, SampleT * inSampT, SpecialAxisBounds * inSAB) {
    TH3F * h_3DCurr;
...
inline void BookHists(vector<HistogramT> * inHistVec, HMap_1D &inHMap_1D, HMap_2D &inHMap_2D, HMap_3D &inHMap_3D, SampleT * inSampT, SpecialAxisBounds * inSAB, int numDims) {
    switch (numDims) {
        case 1:

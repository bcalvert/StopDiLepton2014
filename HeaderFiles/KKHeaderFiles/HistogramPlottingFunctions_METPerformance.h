#ifndef HISTOGRAM_PLOTTING_FUNCTIONS_MET_PERFORMANCE_H
#define HISTOGRAM_PLOTTING_FUNCTIONS_MET_PERFORMANCE_H
///\todo implement better
///\todo huge amount of boiler plate code
#include <vector>

void AddInQtBounds(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
...
void AddInUperpUparBounds(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    int i1start = 0;
    int i1end = i1start + 5;
    int i2start = 0;
    ...
    std::vector<Double_t> vecUPerpUPar;
...
void AddInUparDivQtBounds(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    ...
    std::vector<Double_t> vecUParDivQt;
...
void AddInNVtxBounds(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {

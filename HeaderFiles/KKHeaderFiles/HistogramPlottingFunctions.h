#ifndef HISTOGRAM_PLOTTING_FUNCTIONS_H
#define HISTOGRAM_PLOTTING_FUNCTIONS_H
///\todo implement better
///\todo huge amount of boiler plate code

#include <vector>
void AddInKT2_TopBounds(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
    ...
    std::vector<Double_t> vecKT2_Top(numBinsTotal + 1);
    vecKT2_Top[0] = -300.0;
...
void AddInKT2_TopBounds2DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
...
void AddInKT2_TopBounds3DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     300 GeV Signal from -300 to 0 -- 1 bin
     100 GeV bins from 0 to 200 -- 2 bins
     300 GeV bin from 200 to 500 -- 1 bin
...
void AddInMT2bb_ZMETBounds2DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
    ...
    std::vector<Double_t> vecMT2bb_ZMET(numBinsTotal + 1);
...
void AddInMT2bb_ZMETBounds3DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     100 GeV bin from 70 to 170 -- 1 bin
     30 GeV bin from 170 to 200 -- 1 bin
     50 GeV bins from 200 to 250 -- 1 bins
...
void AddInMT2bb_ZMETBounds_NonControl(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
...
void AddInMT2bb_ZMETBounds_Control(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
...
void AddInMT2lblbBounds_NonControl(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
    ...
    std::vector<Double_t> vecMT2lblb(numBinsTotal + 1);
    vecMT2lblb[0] = 0.0;
...
void AddInMT2lblbBounds3DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     170 GeV bin from 0 to 170 -- 1 bin
     30 GeV bin from 170 to 200 -- 1 bin
     50 GeV bins from 200 to 250 -- 1 bins
    ...
    const int numRanges = 4;
    int binRangeIndexEPs[numRanges] = {2, 3, 4, 5};
    int stepSize[numRanges] = {170, 30, 50, 200};
...
void AddInMT2lblbBounds2DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     170 GeV bin from 0 to 170 -- 1 bin
     30 GeV bin from 170 to 200 -- 1 bin
     50 GeV bins from 200 to 250 -- 1 bins
...
void AddInMT2lblbBounds_Control(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
...
void AddInMT2llBounds_NonControl(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     1 GeV bin right at 0 -- 1 bin
    ...
    std::vector<Double_t> vecMT2ll(numBinsTotal + 1);
    vecMT2ll[0] = 0.0;
    const int numRanges = 5;
...
void AddInMT2llBounds2DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
...
void AddInMT2llBounds3DShape(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     80 GeV bin from 0 to 80 -- 1 bin
...
void AddInMT2llBounds_Control(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     80 GeV bin from 0 to 80 -- 1 bin
     5 GeV bins 80 to 120 -- 8 bins
     80 GeV Signal bin after 120 -- 1 bin
...
void AddInDilepPtBounds(std::vector< std::vector<Double_t> > * inVecVecBinEdges, std::vector<int> * vecNumBins) {
    /*
     ...
     */
    const int numBinsTotal = 18;
    std::vector<Double_t> vecDiLepPt(numBinsTotal + 1);
    vecDiLepPt[0] = 0.0;
    const int numRanges = 4;
...
#endif // HISTOGRAM_PLOTTING_FUNCTIONS_H
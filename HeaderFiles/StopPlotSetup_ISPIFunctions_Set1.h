...
void HistogramAdderProjector(AxisProjInfo * inAPI, HistDisplayParams * inHDP, vector<IndSamplePlotInfo> * vecISPI_asLoaded, IndSamplePlotInfo * compISPI, TString compName, bool doVerbosity = false, vector<SampDisplay> * vecIndMC_SampDisplays = 0, vector<indMCParams> * vecIndMCParams = 0) {

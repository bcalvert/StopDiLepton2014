...
void SetInTreeBranchSUSY(TTree * fileTree, GenSUSYEventPointers * inGSEPs) {
...
void SetInTreeBranchGenLep(TTree * fileTree, GenLeptonEventPointers * inGLEPs) {
    TString prefixGenPart = "T_Gen_";
    const int numLeps = 2;
...
void SetInTreeBranchGenQuark(TTree * fileTree, GenQuarkEventPointers * inGQEPs) {
    TString prefixGenPart = "T_Gen_";
    const int numQuarks = 2;
    TString nameQuark[numQuarks] = {"t", "b"};
    
    GenParticlePointers_St3 * GenQuark_PPSt3ToSet;
    GenParticlePointers_St1 * GenQuark_PPSt1ToSet;
...
void SetInTreeBranchGenJet(TTree * fileTree, GenJetEventPointers * inGJEPs) {
...
void SetInTreeBranchRecoElec(TTree * fileTree, ElectronEventPointers * inEEPs) {
...
void SetInTreeBranchRecoMuon(TTree * fileTree, MuonEventPointers * inMEPs) {
...
void SetInTreeBranchRecoJet(TTree * fileTree, PFJetEventPointers * inPFJEPs) {
    
    TString prefixRecoJet = "T_JetAKCHS_";
    ////Jet Branches
...
void SetInTreeBranchMET(TTree * fileTree, EventMETInfo * inEMI) {
...
void SetInTreeBranchFilterTrigger(TTree * fileTree, FilterTriggerInfo * inFTI) {
    //Trigger information

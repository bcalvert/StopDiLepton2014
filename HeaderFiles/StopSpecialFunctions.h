...
inline float getMT2(TLorentzVector lept1, TLorentzVector lept2, float theMET, float theMETphi, float inputTestMass = 0){
...
inline float getMT2MN(TLorentzVector lept1, TLorentzVector lept2, float theMET, float theMETphi, float inputMass){
    // Calculate MT2 variable for two leptons and missing energy, assuming zero testmass
    double pa[3];
    double pb[3];
    double pmiss[3];
